...
<h5 id="BP_kozgyules">Composition of the General Assembly of Budapest</h5>
...
<h5 id="megyei_lista">Composition of county assemblies (based on the county list votes)</h5>
